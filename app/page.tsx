      ...
      <main className="bg-[#2C191D] w-full h-screen font-courier-prime grid place-content-center">
        <div className="relative bg-[#FDFBF5] border-2 border-[#2C191D] w-full shadow-boxes-big shadow-[#D36951] p-10">
          ...
          <form action={action} className="flex flex-col gap-y-4 pt-10">
            <div>
              <label htmlFor="username" className="text-xs tracking-widest font-bold uppercase text-[#5B4C4F] flex flex-col gap-y-2">
                username
                <input className="text-[#2C191D] text-sm bg-[#F5F1DE] border-2 border-[#2C191D] p-3 w-80" type="text" name="username" placeholder="useridk123" />
              </label>
            </div>
            <div>
              <label htmlFor="password" className="text-xs tracking-widest font-bold uppercase text-[#5B4C4F] flex flex-col gap-y-2">
                password
                <input className="text-[#2C191D] text-sm bg-[#F5F1DE] border-2 border-[#2C191D] p-3 w-80" type="password" name="password" id="password" placeholder="••••••" />
              </label>
            </div>
            ...
            <button type="submit" className="cursor-pointer mt-6 w-fit px-6 text-md py-2 bg-[#BD5740] uppercase text-[#F5F1DE] mx-auto border-2 border-[#2C191D] shadow-boxes-small shadow-[#2C191D]">log in</button>
          </form>
